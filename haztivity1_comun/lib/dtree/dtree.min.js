...
function dTree(objName) {
    ...
    this.icon = {
        root: '../haztivity1_comun/lib/dtree/imgTree/empty.gif',
        folder: 'imgTree/folder.gif',
        folderOpen: 'imgTree/empty.gif',
        empty: '../haztivity1_comun/lib/dtree/imgTree/empty.gif',
        node: '../haztivity1_comun/lib/dtree/imgTree/bullet_naranja.png',
...
dTree.prototype.node = function(node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        if (!node.iconOpen) node.iconOpen = (node._hc) ? this.icon.node : this.icon.node;
    ...
    if (node.url) {
        ...
        if (this.config.useSelection && ((node._hc && this.config.folderLinks) || !node._hc))
            str += ' onclick="javascript: ' + this.obj + '.s(' + nodeId + '); colocaPagina(\'' + node.url + '\'); return false; "';
        str += '>';
